...
ALTER TABLE tagihan
  MODIFY status_tagihan VARCHAR(20) NOT NULL DEFAULT 'BELUM BAYAR';
...
ALTER TABLE keluhan
  MODIFY status VARCHAR(20) NOT NULL DEFAULT 'BARU';
...
ALTER TABLE tugas_teknisi
  MODIFY status VARCHAR(20) NOT NULL DEFAULT 'DITUGASKAN';
...
ALTER TABLE notifikasi
  MODIFY status_baca VARCHAR(20) NOT NULL DEFAULT 'BELUM';
